...
module.exports = {
  ...
  theme: {
    screens: {
      ...
      // for AgentGPT
      Axs: "300px",
      "Asm-h": { raw: "(min-height: 700px)" },
      "Amd-h": { raw: "(min-height: 800px)" },
      "Alg-h": { raw: "(min-height: 1000px)" },
    },
    extend: {
      colors: {
        primary: {
  ...
  plugins: [
    ...
    plugin(function ({ addBase, addComponents, addUtilities }) {
      ...
      addComponents({
        ...
        ".btn-blue": {
          "@apply btn bg-primary-3 border-primary-1 text-n-1 fill-n-1 hover:bg-primary-3/90 hover:border-transparent":
            {},
        },
        ".btn-red": {
