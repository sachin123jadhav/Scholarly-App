    ...
    <div className="flex items-center mr-auto">
      ...
      <div className="pl-4 grow">
        ...
        <div className="flex items-center">
          <div className="flex">
            <Icon className="w-5 h-5 mr-2 fill-accent-5 md:w-4 md:h-4 md:mr-1" name="star-rating" />
            <Icon className="w-5 h-5 mr-2 fill-accent-5 md:w-4 md:h-4 md:mr-1" name="star-rating" />
            <Icon className="w-5 h-5 mr-2 fill-accent-5 md:w-4 md:h-4 md:mr-1" name="star-rating" />
            <Icon className="w-5 h-5 mr-2 fill-accent-5 md:w-4 md:h-4 md:mr-1" name="star-rating" />
            <Icon className="w-5 h-5 fill-n-4 md:w-4 md:h-4" name="star-rating" />
          </div>
          <div className="px-2 ml-2 font-semibold rounded-lg bg-n-3 base2 text-n-7">4.85</div>
        </div>
      </div>
    </div>
