...
const ModalShareChat = ({ visible, onClose }) => {
  const [link, setLink] = useState("https://ui8.net/ui8/products/brainwave-ai-ui-design-kit");
  ...
  return (
    ...
    >
      <form className="p-12 md:p-5" action="" onSubmit={() => console.log("Submit")}>
        ...
        <div className="mb-4 font-semibold base2 text-n-6 dark:text-n-3">Copy link</div>
        <div className="relative mb-8">
          ...
          <CopyToClipboard text={link} onCopy={onCopy}>
            <button className="absolute btn-dark top-1 right-1" ref={copyButtonRef} type="button">
              Copy
            </button>
          </CopyToClipboard>
        </div>
        <div className="mb-4 font-semibold base2 text-n-6 dark:text-n-3">Or share to members</div>
        <MultiSelect
          className="mb-8"
          items={people}
        ...
        <div className="flex justify-end">
          <button className="mr-3 btn-stroke-light" onClick={onClose}>
            Cancel
          </button>
